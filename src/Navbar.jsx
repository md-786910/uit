                ...
                <div id="mynav">
                    ...
                    <div id="soemLink">
                        <marquee behavior="alternate" direction="ltr">  <ul id="someourLink">
                            <li id="redcolor" style={{ color: "rgb(255, 23, 70)" }}>Lorem ipsum dolor sit amet consectetur adipisicing.</li>
                            <li id="cyancolor" style={{ color: "cyan" }}>Lorem ipsum dolor sit amet consectetur adipisicing.</li>
                            <li className="cyanColor" style={{ color: "cyan" }}>Lorem ipsum dolor sit amet consectetur adipisicing.</li>
                        </ul></marquee>
                    </div>
